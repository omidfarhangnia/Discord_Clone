...
export default function NavBar() {
  ...
  return (
    <nav
      className={`flex justify-center items-center min-[992px]:mb-[80px] py-5 px-6 sm:px-10 sticky min-[992px]:relative top-0 left-0 ${
    ...
    >
      <div className="max-w-[1200px] w-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          {pageWidth < 992 && <img src={BurgurIcon} alt="burger icon" />}
        </div>
      </div>
    </nav>
  );
